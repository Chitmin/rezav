...
const PhoneInput: React.FC<PhoneInputProps> = ({ className, onChange, value, ...props }) => {
    return (
        <RPNInput.default
...
function guessCountry() {
    return getCountryForTimezone(Intl.DateTimeFormat().resolvedOptions().timeZone);
}

export { guessCountry, PhoneInput };
